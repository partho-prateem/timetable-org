...
const sample = [
  { id: 's1', title: 'A', color: '#fff', day: 'Mon', hour: 9, duration: 2, batch: 'b1', faculty: 'f1', room: 'r1' },
  { id: 's2', title: 'B', color: '#fff', day: 'Mon', hour: 10, duration: 1, batch: 'b1', faculty: 'f2', room: 'r2' },
  { id: 's3', title: 'C', color: '#fff', day: 'Tue', hour: 9, duration: 1, batch: 'b2', faculty: 'f1', room: 'r1' },
];
