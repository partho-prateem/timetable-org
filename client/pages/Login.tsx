    ...
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      <div className="hidden md:flex items-center justify-center bg-gradient-to-br from-violet-600 via-indigo-600 to-sky-500 p-8 text-white">
        <div className="max-w-md">
          ...
          <p className="mt-2 text-white/80">Smart timetable planning with drag-and-drop and AI suggestions.</p>
        </div>
      </div>
          ...
          <CardContent>
            {!configured ? (
              <Alert variant="destructive" className="mb-4">
                <AlertDescription>
                  Supabase not configured. Set VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY. You can also [Connect to Supabase](#open-mcp-popover).
                </AlertDescription>
              </Alert>
            ) : null}
            {error ? (
