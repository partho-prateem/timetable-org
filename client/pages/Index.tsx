    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-sky-50 to-white">
      <header className="max-w-6xl mx-auto px-6 py-6 flex items-center gap-3">
        ...
        <div className="ml-auto space-x-3">
          ...
          <a
            className="inline-flex items-center justify-center rounded-md bg-foreground text-background px-3 py-1.5 text-sm font-medium"
            href="/dashboard"
          >
            Open App
          </a>
      ...
      <main className="max-w-6xl mx-auto px-6 py-16 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-prose">
            Build conflict-free schedules with drag-and-drop, compare
            alternatives side-by-side, and let AI suggest optimal arrangements.
          </p>
          ...
          <div className="mt-8 grid grid-cols-3 gap-4 text-sm">
            <Feature
              title="Drag-and-drop"
              desc="Move classes across the grid seamlessly"
            />
            <Feature
              title="AI Suggestions"
              desc="One-click rearrangement ideas"
            />
            <Feature
              title="Admin Control"
